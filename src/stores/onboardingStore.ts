...
export const useOnboardingStore = defineStore('onboarding', {
  state: () => ({
    ...
    persona: LocalStorage.getItem('onboarding_persona') || { id_pais: 2, id_sexo: 1, id_expedido: null, tratamiento: '', correo_institucional: '' } as any,
        ...
        if (resp.data.success) {
          ...
          if (pre) {
            ...
            this.persona = {
              ...
              correo_institucional: pre.correo_institucional || pre.empleado?.correo_institucional || '',
