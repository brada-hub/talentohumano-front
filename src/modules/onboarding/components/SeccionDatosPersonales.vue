    ...
    <q-card-section class="row q-col-gutter-xl q-pa-xl">
      ...
      <div class="col-12 col-md-9">
        <div class="row q-col-gutter-lg">
          ...
          <div class="col-12 col-md-4"><q-input v-model="persona.celular_personal" @update:model-value="save" label="Teléfono Celular" outlined dense stack-label class="input-marble" :rules="[val => val && val.length >= 8 || 'Mín. 8 dígitos']" /></div>
...
// Opciones dinámicas desde el store
...
const save = () => {
  if (persona.value.primer_apellido) persona.value.primer_apellido = persona.value.primer_apellido.toUpperCase()
  if (persona.value.segundo_apellido) persona.value.segundo_apellido = persona.value.segundo_apellido.toUpperCase()
  if (persona.value.nombres) persona.value.nombres = persona.value.nombres.toUpperCase()
  if (persona.value.ci) persona.value.ci = persona.value.ci.toUpperCase()
  if (persona.value.complemento) persona.value.complemento = persona.value.complemento.toUpperCase()
  if (persona.value.direccion_domicilio) persona.value.direccion_domicilio = persona.value.direccion_domicilio.toUpperCase()
